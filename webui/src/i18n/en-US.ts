const enUS = {
  ...
  'logs.detail': 'Execution Detail',
  'logs.liveStream': 'Live Execution',
  'logs.waiting': 'Waiting for execution...',
  'logs.status.running': 'running',
  'logs.status.success': 'success',
  'logs.status.failed': 'failed',
  'logs.step.index': 'Step {index}',
  'logs.step.elapsed': '{ms}ms',
  'logs.step.error': 'Error: {message}',
  'logs.step.result.captured': 'Screenshot captured',
  'logs.step.result.found': 'Match found (confidence {confidence}%)',
  'logs.step.result.notFound': 'No match found',
  'logs.step.result.clicked': 'Clicked ({x}, {y})',
  'logs.step.result.keys': 'Keys: {keys}',
  'logs.step.result.typed': 'Text typed',
  'logs.step.result.waited': 'Waited {ms}ms',
  'logs.step.result.condition': 'Condition: {found}',
  'logs.step.result.loop': 'Looped {iterations} times',
  'logs.step.result.combo': 'Executed {count} steps',
  'logs.totalDuration': 'Total duration',
  'logs.totalSteps': 'Total steps',
  'logs.failedAt': 'Failed at',
  'logs.backToList': '← Back to list',
  'logs.noSteps': 'No step records',
